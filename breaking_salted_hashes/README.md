| Secure Communications – TUDublin | 
| ------ | 
...
You just need to upload your final user:password pairs for any of the hashes that you managed to brute force and then demo your approach in your lab report (commands or script, salt tested, and full-window screenshots to reproduce your results).

> [Lab Breaking Salted Hashes.md](https://github.com/jinxulabs/Secure-Communications/blob/main/Lab%20Breaking%20Salted%20Hashes.md)
