...
subtitle: "Lab 2b: Basic Pen Testing - A Simulated Pen Test"
...
![$ 'ip a' output showing IP address (192.168.0.11/24)](./img/screenshot01.png)
...
![$ 'nmap -sn' output showing live hosts and TVM IP address (192.168.0.118)](./img/screenshot02.png)
...
![$ 'nmap -sV' output showing open ports and services on TVM (22, 80, 139, 445, 8009, 8080)](./img/screenshot03.png)
...
![$ 'nmap -sV -A -p- -T4' output showing detailed service information and potential vulnerabilities](./img/screenshot04.png)
...
![$ 'nmap -sV -A --script vuln' output showing potential vulnerabilities and interesting directories](./img/screenshot05.png)
...
![$ 'nmap -sV -T4 --script vuln --script-timeout 15s --stats-every 5s -vv' output showing detailed vulnerability scan results](./img/screenshot06.png)
...
![$ 'nikto -h' output showing directory listing](./img/screenshot07.png)
...
![$ 'dirb' output showing directory listing](./img/screenshot08.png)
...
![$ 'curl' output showing directory listing](./img/screenshot09.png)
...
![$ 'curl' output showing contents of dev.txt and j.txt](./img/screenshot10.png)
...
![web browser screenshot showing directory listing](./img/screenshot11.png)
...
![$ 'enum4linux' output showing usernames (kay, jan)](./img/screenshot12.png)
...
![$ 'hydra' output showing successful SSH brute force attack with credentials (jan:armando)](./img/screenshot13.png)
...
![$ 'ssh' output showing successful login as jan](./img/screenshot14.png)
...
![$ 'ls -la' make research on the TVM files and directories (/home/kay/pass.bak)](./img/screenshot15.png)
...
![$ 'find / -perm -4000' output showing SUID binaries and potential privilege escalation vectors (/usr/bin/vim.basic)](./img/screenshot16.png)
...
![$ 'vim pass.bak' output showing retrieved credentials for kay](./img/screenshot17.png)

**Result:** Super user access obtained  
**Screenshot:**

![$ 'su kay' output showing successful privilege escalation to kay](./img/screenshot18.png)
...
![$ 'cat flag.txt' output showing the contents of the flag and how we get to it](./img/screenshot19.png)
