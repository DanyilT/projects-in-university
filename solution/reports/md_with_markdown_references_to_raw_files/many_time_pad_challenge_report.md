...
![Screenshot: Initial Decryption](https://raw.githubusercontent.com/DanyilT/projects-in-university/refs/heads/assessment/year03/module-secure_communications/challenge-labs/many_time_pad/solution/screenshots/screenshot_program_01.png)
...
### Refinement Process
![Screenshot: Refinement Session - Message 1](https://raw.githubusercontent.com/DanyilT/projects-in-university/refs/heads/assessment/year03/module-secure_communications/challenge-labs/many_time_pad/solution/screenshots/screenshot_program_t_01.png)
...
|---------|-----------------|------------|
| 2       | "The Internet is the most important single development in the history of human communication since the invention of call waiting" | ![Screenshot: Refinement Session - Message 2](https://raw.githubusercontent.com/DanyilT/projects-in-university/refs/heads/assessment/year03/module-secure_communications/challenge-labs/many_time_pad/solution/screenshots/screenshot_program_t_02.png) |
| 3       | "I am sorry to say that there is too much point to the wisecrack that life is extinct on other planets because their scientists were more advanced than ours" | ![Screenshot: Refinement Session - Message 3](https://raw.githubusercontent.com/DanyilT/projects-in-university/refs/heads/assessment/year03/module-secure_communications/challenge-labs/many_time_pad/solution/screenshots/screenshot_program_t_03.png) |
| 4       | "The world is very different now For man holds in his mortal hands the power to abolish all forms of human poverty and all forms of human life John F Kennedy" | ![Screenshot: Refinement Session - Message 4](https://raw.githubusercontent.com/DanyilT/projects-in-university/refs/heads/assessment/year03/module-secure_communications/challenge-labs/many_time_pad/solution/screenshots/screenshot_program_t_04.png) |
| 5       | "All of the books in the world contain no more information than is broadcast as video in a single large American city in a single year Not all bits have equal value" | ![Screenshot: Refinement Session - Message 5](https://raw.githubusercontent.com/DanyilT/projects-in-university/refs/heads/assessment/year03/module-secure_communications/challenge-labs/many_time_pad/solution/screenshots/screenshot_program_t_05.png) |
| 6       | "Champagne if you are seeking the truth is better than a lie detector It encourages a man to be expansive even recklesswhile lie detectors are only a challenge to tell lies successfully" | ![Screenshot: Refinement Session - Message 6](https://raw.githubusercontent.com/DanyilT/projects-in-university/refs/heads/assessment/year03/module-secure_communications/challenge-labs/many_time_pad/solution/screenshots/screenshot_program_t_06.png) |
| 7       | "Building technical systems involves a lot of hard work and specialized knowledge languages and protocols coding and debugging testing and refactoring" | ![Screenshot: Refinement Session - Message 7](https://raw.githubusercontent.com/DanyilT/projects-in-university/refs/heads/assessment/year03/module-secure_communications/challenge-labs/many_time_pad/solution/screenshots/screenshot_program_t_07.png) |
...
| Message | Plaintext Guess | Screenshot |
|---------|-----------------|------------|
| 8       | "Its impossible to move to live to operate at any level without leaving traces bits seemingly meaningless fragments of personal information" | ![Screenshot: Refinement Session - Message 8](https://raw.githubusercontent.com/DanyilT/projects-in-university/refs/heads/assessment/year03/module-secure_communications/challenge-labs/many_time_pad/solution/screenshots/screenshot_program_t_08.png) |
| 9       | "One machine can do the work of fifty ordinary men No machine can do the work of one extraordinary man" | ![Screenshot: Refinement Session - Message 9](https://raw.githubusercontent.com/DanyilT/projects-in-university/refs/heads/assessment/year03/module-secure_communications/challenge-labs/many_time_pad/solution/screenshots/screenshot_program_t_09.png) |
...
| Message | Plaintext Guess | Screenshot |
|---------|-----------------|------------|
| 10      | "I used to think that cyberspace was fifty years away What I thought was fifty years away was only ten years away And what I thought was ten years away it was already here I just wasnt aware of it yet" | ![Screenshot: Refinement Session - Message 10](https://raw.githubusercontent.com/DanyilT/projects-in-university/refs/heads/assessment/year03/module-secure_communications/challenge-labs/many_time_pad/solution/screenshots/screenshot_program_t_10.png) |
...
| Message | Plaintext Guess | Screenshot |
|---------|-----------------|------------|
| 11      | "We are the children of a technological age We have found streamlined ways of doing much of our routine work Printing is no longer the only way of reproducing books Reading them however has not changed" | ![Screenshot: Refinement Session - Message 11](https://raw.githubusercontent.com/DanyilT/projects-in-university/refs/heads/assessment/year03/module-secure_communications/challenge-labs/many_time_pad/solution/screenshots/screenshot_program_t_11.png) |
...
| Message | Plaintext Guess | Screenshot |
|---------|-----------------|------------|
| 12      | "Style used to be an interaction between the human soul and tools that were limiting In the digital era it will have to come from the soul alone" | ![Screenshot: Refinement Session - Message 12](https://raw.githubusercontent.com/DanyilT/projects-in-university/refs/heads/assessment/year03/module-secure_communications/challenge-labs/many_time_pad/solution/screenshots/screenshot_program_t_12.png) |
| 13      | "The Web as I envisaged it we have not seen it yet The future is still so much bigger than the past Tim Berners-Lee" | ![Screenshot: Refinement Session - Message 13](https://raw.githubusercontent.com/DanyilT/projects-in-university/refs/heads/assessment/year03/module-secure_communications/challenge-labs/many_time_pad/solution/screenshots/screenshot_program_t_13.png) |

### Final Key Recovery
![Screenshot: Final Output with Complete Key](https://raw.githubusercontent.com/DanyilT/projects-in-university/refs/heads/assessment/year03/module-secure_communications/challenge-labs/many_time_pad/solution/screenshots/screenshot_program_02.png)
...
> [`many_time_pad_solver.py`](https://raw.githubusercontent.com/DanyilT/projects-in-university/refs/heads/assessment/year03/module-secure_communications/challenge-labs/many_time_pad/solution/code/many_time_pad_solver.py)
```python
#!/usr/bin/env python3
"""
